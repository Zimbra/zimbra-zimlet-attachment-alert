...
The file `src/components/more/index.js` implements the `Attachment Alert Zimlet` reminder dialog. The in-code comments explain how it works:
...
This Zimlet uses a new approach in writing Zimlets, mainly it no longer uses class-based Preact components. Function based Preact components perform a bit better and have less risk of creating memory leaks. To be able to use only class based components this Zimlet uses `preact-context-provider` and `recompose`. Take a look at the file `src/index.js` to find out how it works. Also check the links in the references section.
...
- https://github.com/Zimbra/zimlet-cli/wiki/Capture-Zimbra-events-inside-a-Zimlet
- https://blog.logrocket.com/using-recompose-to-write-clean-higher-order-components-3019a6daf44c/
- https://github.com/Zimbra/zimlet-cli/wiki/Zimlet-Context
- https://github.com/synacor/preact-context-provider/
